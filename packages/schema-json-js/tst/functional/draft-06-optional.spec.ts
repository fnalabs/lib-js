...
describe('functional tests for draft-06 specification - optional', () => {
  let draft6Optional
  ...
  beforeAll(async () => {
    draft6Optional = await getTests('./tst/JSON-Schema-Test-Suite/tests/draft6/optional')
