...
describe('functional tests for draft-06 specification', () => {
  let draft6Tests
  ...
  beforeAll(async () => {
    draft6Tests = await getTests('./tst/JSON-Schema-Test-Suite/tests/draft6', ['boolean_schema.json'])
