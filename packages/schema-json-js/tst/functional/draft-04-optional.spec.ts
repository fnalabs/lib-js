...
describe('functional tests for draft-04 specification - optional', () => {
  let draft4Optional
  ...
  beforeAll(async () => {
    draft4Optional = await getTests('./tst/JSON-Schema-Test-Suite/tests/draft4/optional', ['zeroTerminatedFloats.json'])
